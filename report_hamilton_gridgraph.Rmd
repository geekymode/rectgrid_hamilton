...
Itai et al. left the Hamiltonian cycle problem open for solid grid graphs (a grid graph without holes but the outer boundary is not necessarily rectangular; see Fig- ure 1.2(b)). Later Umans and Lenhart [119, 120] gave a polynomial time algorithm to find a Hamiltonian cycle (if it exists) in a solid grid graph using a cycle merging technique.
